...
class GooglePlayDataCollector:
    ...
    def _save_to_csv(self, query: str, items: List[PlayItem], category: GooglePlayCategory) -> None:
        """Saves given list of play items to a CSV file."""
        output_file_name = f"{query}_{category.value}_{self._output_file}"
    ...
    def save_play_data(self, query: str, category: GooglePlayCategory) -> None:
        ...
        self._save_to_csv(query, items, category)
